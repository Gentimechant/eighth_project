...
describe('controller', function () {
	...
	describe('routing', function () {
		...
		it('should show active entries when user clicks the active button', function () {
			// TODO: write test 
		...
		it('should show completed entries when user clicks the completed button', function () {
			// TODO: write test 
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
			// TODO: write test : 
			var todo = [{id: 42, title: 'my todo', completed: true}, 
						{id: 43, title: 'next todo', completed: false}];
	...
	describe('new todo', function () {
		it('should add a new todo to the model', function () {
			// TODO: write test 
			var todo = {id: 43, title: 'next todo', completed: false};
